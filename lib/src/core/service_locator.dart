...
import 'package:zaracast/src/database/queries/show_queries.dart';
...
void setupServiceLocator() {
  ...
  getIt.registerLazySingleton<ShowQueries>(
    () => ShowQueries(getIt<AppDatabase>()),
  );
}
...
ShowQueries showQueries = getIt.get<ShowQueries>();
